...
define('UC_DBHOST', 'kirktdk-server.mysql.database.azure.com');
define('UC_DBUSER', 'wybdxofhfi');
define('UC_DBPW', '3VL508CT1SVT116W$');
define('UC_DBNAME', 'kirktdk-database');
define('UC_DBCHARSET', 'utf8mb4');
define('UC_DBTABLEPRE', '`kirktdk-database`.pre_ucenter_');
define('UC_DBCONNECT', '0');
define('UC_AVTURL', '');
define('UC_AVTPATH', '');
define('UC_KEY', 'N7w2K5O4n5Xfj3e22dw6f2C4F9i1qbr2D2kcVcx7h82a9e6cGdzaPa9cW1le93Fb');
define('UC_API', 'http://kirktdk.azurewebsites.net/uc_server');
